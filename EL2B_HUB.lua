...
local function showUpdateGui(autoKickOnUpdate, messageFr, messageEn)
	...
	frame.Size = UDim2.fromOffset(360, 218)
	...
	title.Parent = frame
	local schedule = Instance.new("TextLabel")
	schedule.BackgroundTransparency = 1
	schedule.Position = UDim2.fromOffset(20, 50)
	schedule.Size = UDim2.new(1, -40, 0, 18)
	schedule.Font = Enum.Font.GothamMedium
	schedule.TextColor3 = Color3.fromRGB(255, 180, 220)
	schedule.TextSize = 11
	schedule.TextXAlignment = Enum.TextXAlignment.Left
	schedule.Text = "ADMIN ABUSE · SAMEDI 21:00–21:30"
	schedule.Parent = frame
	local message = Instance.new("TextLabel")
	message.BackgroundTransparency = 1
	message.Position = UDim2.fromOffset(20, 72)
	...
	countdown.Position = UDim2.fromOffset(20, 122)
...
Title.Parent = Top
local AdminAbuseSchedule = Instance.new("TextLabel")
AdminAbuseSchedule.Name = "AdminAbuseSchedule"
AdminAbuseSchedule.Size = UDim2.new(1, -120, 0, 14)
AdminAbuseSchedule.Position = UDim2.new(0, 104, 0, 39)
AdminAbuseSchedule.BackgroundTransparency = 1
AdminAbuseSchedule.Text = "Admin Abuse · Samedi 21:00–21:30"
AdminAbuseSchedule.TextColor3 = Color3.fromRGB(255, 180, 220)
AdminAbuseSchedule.TextSize = 9
AdminAbuseSchedule.Font = Enum.Font.GothamMedium
AdminAbuseSchedule.TextXAlignment = Enum.TextXAlignment.Left
AdminAbuseSchedule.Parent = Main
-- gradient chữ menu
...
TabBar.Name = "TabBar"
TabBar.Size = UDim2.new(0, TAB_W, 1, -62)
TabBar.Position = UDim2.new(0, 4, 0, 58)
...
function makePage(name)
	...
	sc.Size = UDim2.new(1, -(TAB_W + 10), 1, -66)
	sc.Position = UDim2.new(0, TAB_W + 8, 0, 62)
